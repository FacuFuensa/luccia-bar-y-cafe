    ...
    <div className="bg-cream border border-sage rounded-lg p-6 flex flex-col gap-5">
      <div>
        ...
        <p className="font-inter text-sm text-charcoal/65 flex items-start gap-2">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" className="mt-0.5 shrink-0">
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
            <circle cx="12" cy="10" r="3" />
          </svg>
          {address}
        </p>
        <p className="font-inter text-sm text-charcoal/65 flex items-center gap-2 mt-1">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-5 py-3 rounded-full font-inter text-sm font-medium hover:bg-[#1db954] transition-colors"
      >
